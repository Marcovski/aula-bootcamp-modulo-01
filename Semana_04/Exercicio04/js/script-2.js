...
function getAttributes() {
    return {
        nome: [getElementById('txtNome'), 'txtNome'],
        email: [getElementById('txtEmail'), 'txtEmail'],
        senha: [getElementById('txtSenha'), 'txtSenha'],
        senha2: [getElementById('txtSenhaConfirma'), 'txtSenhaConfirma'],
        genero: [getElementById('slGenero'), 'slGenero'],
        dataNascimento: [getElementById('txtDataNascimento'), 'txtDataNascimento'],
        sobre: [getElementById('txtSobre'), 'txtSobre']
    };
}
